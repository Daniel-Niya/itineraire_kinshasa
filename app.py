...
GITHUB_BASE_URL = "https://raw.githubusercontent.com/Daniel-Niya/itineraire_kinshasa/main/static/uploads/"

def get_landmark_image_url(filename):
    """Retourne le chemin complet d'une image hébergée sur GitHub"""
    if filename:
        return GITHUB_BASE_URL + filename
    return "https://images.unsplash.com/photo-1552733407-5d5c46c3bb3b?w=400&h=300&fit=crop"
...
POINTS_OF_INTEREST = {
    "Marché Central": {
        "lat": -4.3070,
        "lon": 15.3120,
        "image": get_landmark_image_url("marche_central.jpeg"),
        "type": "commerce",
    ...
    "Stade des Martyrs": {
        "lat": -4.3278,
        "lon": 15.3149,
        "image": get_landmark_image_url("stade_martyrs.jpeg"),
        "type": "sport",
    ...
    "Université de Kinshasa": {
        "lat": -4.4120,
        "lon": 15.3050,
        "image": get_landmark_image_url("unikin.jpeg"),
        "type": "éducation",
    ...
    "Place de la Gare": {
        "lat": -4.30125,
        "lon": 15.31800,
        "image": get_landmark_image_url("place_gare.jpeg"),
        "type": "transport",
    ...
    "Hôpital Général": {
        "lat": -4.3145,
        "lon": 15.2920,
        "image": get_landmark_image_url("images.jpeg"),
        "type": "santé",
    ...
    "Palais du Peuple": {
        "lat": -4.3198,
        "lon": 15.3152,
        "image": get_landmark_image_url("palais-du-peuple.jpg"),
        "type": "gouvernement",
    ...
    "Ambassade de France": {
        "lat": -4.3079,
        "lon": 15.2751,
        "image": get_landmark_image_url("ambassade_de_france.jpeg"),
        "type": "diplomatie",
    ...
    "Aéroport de Ndjili": {
        "lat": -4.3850,
        "lon": 15.4448,
        "image": get_landmark_image_url("ndjili.jpeg"),
        "type": "transport",
    ...
    "Pont Maréchal": {
        "lat": -4.3005,
        "lon": 15.2945,
        "image": get_landmark_image_url("pont_marechal.jpeg"),
        "type": "infrastructure",
    ...
    "Musée National": {
        "lat": -4.3183,
        "lon": 15.2982,
        "image": get_landmark_image_url("musee_national.jpeg"),
        "type": "culture",
    ...
    "Jardin Botanique": {
        "lat": -4.3495,
        "lon": 15.2952,
        "image": get_landmark_image_url("jardin.jpeg"),
        "type": "nature",
    ...
    "Grand Hôtel Kinshasa": {
        "lat": -4.3021,
        "lon": 15.3022,
        "image": get_landmark_image_url("grand_hotel.jpeg"),
        "type": "hôtellerie",
    ...
    "Centre Commercial": {
        "lat": -4.3075,
        "lon": 15.3048,
        "image": get_landmark_image_url("commercial.jpeg"),
        "type": "commerce",
