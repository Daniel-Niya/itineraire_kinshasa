...
def get_landmark_image(landmark_name, filename=None):
    """
    Retourne l'image d'un landmark.
    - Si `filename` est fourni et existe dans static/uploads/, retourne base64.
    - Sinon, retourne une image par défaut depuis Unsplash.
    """
    if filename:
    ...
    # Images par défaut depuis Unsplash si fichier local manquant
    default_images = {
